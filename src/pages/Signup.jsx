...
import { HeartPulse, Lock, Mail, User, ArrowRight, ShieldCheck, AlertCircle } from 'lucide-react';
        ...
        <div className="card" style={{ padding: '2.5rem', borderRadius: 'var(--radius-xl)', boxShadow: 'var(--shadow-xl)' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '0.88rem', color: 'var(--text-muted)' }}>
              Join SYNORA for simple, accessible healthcare companion support
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '1.25rem', lineHeight: '1.4' }}>
              By signing up, you agree to SYNORA's{' '}
